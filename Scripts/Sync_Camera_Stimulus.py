...
def Sync_Camera_Stimulus(syncpath, camera):
    ...
    if camera == 1:
        ...
        frames = np.zeros((len(stim_time), 1))
...
def getRunningData(pklpath, frame):
    ...
    dxcm = ((
            dx / 360) * 5.5036 * np.pi * 2) / vsync_intervals  # converts to cm/s assuming 6.5" wheel with mouse at 2/3 r
...
if __name__ == '__main__':
    syncpath = r'C:\Users\mahdir\Desktop\Mahdi files\501560436_222179_20160204_sync.h5'
    pklpath = r'C:\Users\mahdir\Desktop\Mahdi files\501560436_222179_20160204_stim.pkl'
    frames = Sync_Camera_Stimulus(syncpath, 1)
    dxds = getRunningData(pklpath, frames)
    # joblib.dump(dxds, 'dxds500860585.pkl')
    print('done syncing')
    # k = joblib.load('frames2.pkl')
    # u= joblib.load('dxds2.pkl')